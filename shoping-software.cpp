    ...
    if (strcmp(username, correctUsername) == 0 && strcmp(password, correctPassword) == 0)
    {
        ...
        while (1)
        {
            ...
            case 1:
                ...
                scanf("%s", productname[productCount]); // Store the product name in the array
            ...
            case 2:
                if (productCount > 0)
                {
                    printf("\033[1;33mEnter the index of the product to remove: \033[0m");
                    int index;
                    scanf("%d", &index);
                    index = index - 1;
                    ...
                    {
                        printf("\033[1;35mInvalid index or product is already removed. Please enter a valid product index.\033[0m\n");
                    }
                }
                else
                {
            ...
            case 4:
                ...
                printf("\n \033[1;34m_________________________________________\n\033[0m");
                printf(" \033[5;36mTAX INVOICE\033[0m \n");
                BILL();
                printf(" \033[1;34m_________________________________________\n\033[0m");
